...
// "this" refers to the "joe" instance of the student object.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" now refers to the global window object.
// 3. Explain why "this" is different when an arrow function is used.
// When we use the arrow notation, the overall meaning of "this" is no longer reset in the function itself. It is read as a surround non-arrow function or in the context of global window object if there is not an non-arrow function.
